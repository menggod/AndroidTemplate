...
import com.common.baselib.transformer.BGAPageTransformer;
import com.common.baselib.transformer.TransitionEffect;
...
public class Banner extends RelativeLayout implements BannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.banner_point_solid_selector;
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.Banner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.banner_point_solid_selector);
    ...
    public void showPlaceholder() {
        if (mPlaceholderIv == null && mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = BannerUtil.getItemImageView(getContext(), mPlaceholderDrawableResId, new BannerLocalImageSize(720, 360, 640, 320), mScaleType);
     ...
     */
    public void setData(@Nullable BannerLocalImageSize localImageSize, @Nullable ImageView.ScaleType scaleType, @DrawableRes int... resIds) {
        if (localImageSize == null) {
            localImageSize = new BannerLocalImageSize(720, 1280, 320, 640);
        }
        if (scaleType != null) {
