package com.common.baselib.immersion;
 ...
 * 沉浸式状态栏工具
 * use  cases  OnCreate
 *  color             StatusBarUtils.setColor(this, getResources().getColor(R.color.colorPrimaryDark));
 *  transparent  StatusBarUtils.setTransparent(this);
 */
...
//        return darkness >= 0.5;
     ...
     * @param activity
     */
    public static void setTransparentNoStatus(Activity activity){
        ...
        // 适配Android 4.4
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            StatusBarUtils.setColor(activity.getWindow(), Color.TRANSPARENT, true);
        }
    }
}
